...
//３．データ登録SQL作成
$sql = "INSERT INTO avails_user_table(name,lid,lpw,UserRoleId,life_flg)VALUES(:name,:lid,:lpw,:UserRoleId,1)";
...
$stmt->bindValue(':UserRoleId', $UserRoleId, PDO::PARAM_INT); //Integer（数値の場合 PDO::PARAM_INT)
$status = $stmt->execute();
